...
def _action_run(job: Dict[str, Any], a: Dict[str, Any]) -> str:
    ...
    try:
        ...
        finite_session = bool(a["session_id"]) and not async_delivery_supported()
    except Exception:
...
Finite/stateless agent sessions enqueue run requests for the next scheduler tick and must omit transient prompt context.
