...
class TurnFacadeMixin:
    ...
    def run_conversation(
        ...
        from agent.completion_reserve import continue_once, contract as completion_reserve_contract, is_iteration_limit, turns_for_platform
            ...
            with bind_subagent_parent(self), scoped_runtime_main({}):
                try:
                    ...
                    result = run_conversation(
                        self, first_user_message, system_message, conversation_history, effective_task_id,
                        stream_callback, first_persist_user_message,
