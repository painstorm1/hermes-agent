...
def _rebuild_desktop_after_update(desktop_dir: Path, *, had_desktop_app_before_update: bool) -> bool:
    """Keep stable's failure receipt semantics with FN transactional package recovery."""
    from hermes_cli.update_cmd import _maybe_rebuild_desktop
    return _maybe_rebuild_desktop(had_desktop_app_before_update or _desktop_app_present(desktop_dir))
